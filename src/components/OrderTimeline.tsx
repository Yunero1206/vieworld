...
export function OrderTimeline({order}:{order:Order}){
 ...
 return <section className="v6-order-journey" aria-label="Tiến trình trạng thái đơn hàng" data-testid={`order-timeline-${order.id}`}>
  ...
  <div className="vw-order-empathy-note" style={{ padding: '8px 12px', background: 'var(--surface-subtle, #F3F4F6)', borderRadius: 'var(--radius-md, 8px)', margin: '10px 0 14px', fontSize: '12.5px', color: 'var(--ink, #111827)' }}>
    <span style={{ color: 'var(--primary, #5B46E8)', fontWeight: '700' }}>♥ VieWorld gửi gắm: </span>
    <span>Mỗi kỷ vật đều mang theo tình cảm của cộng đồng. Chúc bạn có những phút giây trọn vẹn cùng giai điệu yêu thích.</span>
  </div>
